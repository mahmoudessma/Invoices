                                    ...
                                    <table id="example" class="table key-buttons text-md-nowrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>  
                                                    <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale" data-id="{{$product->id}}" data-section_name="{{$product->sections->section_name}}"
                                                 data-description="{{$product->description}}" data-product_name="{{$product->product_name}}" data-toggle="modal"
                                                 href="#exampleModal2" title="تعديل"><i class="las la-pen"></i></a>
                                                 
                                                 <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                                 data-id="" data-product_name="{{ $product->product_name }}"
                            ...
                            <div class="modal-content modal-content-demo">
                                ...
                                <div class="modal-body">
                                    <form action="{{route('products.store')}}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1"> حدد القسم</label>
